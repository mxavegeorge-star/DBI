  ...
  if (serverStatus === 'closed' && step !== 'admin') {
    return (
      <div className="min-h-screen bg-[#0A0A0A] flex flex-col items-center justify-center p-6 text-center">
        ...
        {/* Admin Access at bottom left */}
        <button 
          onClick={() => {
            setStep('admin');
            setError('');
            fetchServerStatus(); // Refresh status when entering admin
          }}
        ...
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-6">
            ...
            <button 
              ...
              className="hidden md:flex items-center gap-2 text-xs font-semibold text-white/40 hover:text-white transition-colors border border-white/10 px-3 py-1.5 rounded-lg bg-white/5"
            >
              <Lock className="w-3 h-3" /> Admin Panel
            </button>
          </div>
          ...
          <button className="px-5 py-2.5 bg-white text-black text-sm font-semibold rounded-full hover:bg-white/90 transition-all active:scale-95 select-none">
            Get Started
          </button>
        </div>
      </header>
          ...
          {step === 'payment' && (
            ...
            >
              <div className="text-center space-y-2">
                ...
                <p className="text-white/50">Scan the QR code to pay via Crypto or UPI</p>
              </div>
                ...
                <div className="w-full space-y-4">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-3 p-4 rounded-xl bg-white/5 border border-white/10">
                      ...
                      <div className="text-sm font-medium text-white/80">Scan with any UPI or Crypto App</div>
                    </div>
                  </div>
                </div>
